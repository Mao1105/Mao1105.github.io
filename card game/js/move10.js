 ...
 * 参数：
 	obj:要运动的元素
 	attrs:要改变的多个属性，传入对象{top:800,width:800}，即使只有一个属性，也要写在对象里
 	duration：运动持续时间
...
function shakeL(obj,attr,endFn){
    var arr = [];
    var timer = null;
    var n = 0;
    if(!obj.num){
...
function shakeR(obj,attr,endFn){
    var arr = [];
    var timer = null;
    var n = 0;
    if(!obj.num){
...
//拖拽函数
//obj:需要拖拽的对象
function drafting(obj,parent){
    obj.onmousedown=function(e){
        var l=e.clientX-obj.offsetLeft;
        var t=e.clientY-obj.offsetTop;
        document.onmousemove=function(e){
            var objLeft=e.clientX-l;
            var objTop=e.clientY-t;
            if(parent){
                var maxLeft=parent.offsetWidth-obj.offsetWidth;
                var maxLeft=parent.offsetHeight-obj.offsetHeight;
